========================================================================
    KONSOLENANWENDUNG: Übung3 Wiederverwendung vorhandener Klassen-Projektübersicht
========================================================================

Diese Übung3 Wiederverwendung vorhandener Klassen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Übung3 Wiederverwendung vorhandener Klassen-Anwendung besteht.


Übung3 Wiederverwendung vorhandener Klassen.vcxproj
...
Übung3 Wiederverwendung vorhandener Klassen.vcxproj.filters
...
Übung3 Wiederverwendung vorhandener Klassen.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Übung3 Wiederverwendung vorhandener Klassen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
